...
{
    /// <summary>
    /// World-space UI for Balance Bot bridge (port 9093) + offline ONNX start.
    /// </summary>
    public sealed class BalanceBotBridgePanel : MonoBehaviour
    {
        public RosTcpClient client;
        public BalanceBotBallFollower ballFollower;
        public BalanceBotLinkPoseFollower robotFollower;
        public BalanceBotOfflinePolicyController offlinePolicy;
        ...
        void SetMirror()
        {
            ...
            if (ballFollower != null)
                ballFollower.followingEnabled = true;
        ...
        void ToggleOfflinePolicy()
        {
            ...
            else
            {
                ...
                if (ballFollower != null)
                    ballFollower.followingEnabled = false;
        ...
        {
            if (modeText != null)
                modeText.text = offlinePolicy != null && offlinePolicy.running ? "Offline Policy" : "Mirror Isaac";
        ...
        void RefreshStatusLine()
        {
            ...
            statusText.text = $"BalanceBot :9093 · {conn} · {_phase} · {pol}";
        }
    }
}
