...
from .xrplayground_marl_env_cfg import XrplaygroundMarlEnvCfg


class XrplaygroundMarlEnv(DirectMARLEnv):
    cfg: XrplaygroundMarlEnvCfg

    def __init__(self, cfg: XrplaygroundMarlEnvCfg, render_mode: str | None = None, **kwargs):
